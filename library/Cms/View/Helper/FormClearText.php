...
*/
class Cms_View_Helper_FormClearText extends Zend_View_Helper_FormElement {
  /**
   * Generates text.
   *
   * @access public
  ...
  */
  public function formClearText($name, $value = null, $attribs = null) {
    $info = $this->_getInfo($name, $value, $attribs);
    extract($info); // name, value, attribs, options, listsep, disable
    //if (null === $value) {$value = $name;}

//        $xhtml =  $this->view->escape($value).'<input type="hidden"'
$xhtml = null;
