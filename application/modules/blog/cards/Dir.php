<?php
class Blog_Card_Dir extends Cms_CardTree
{
    ...
    public function editForm(){
        ...
        $elm = $obj->createElement('profile_file_name',$this->getZca()->view,$this->filePath,$oldFileName);
        $form->addElement($elm);
        */
